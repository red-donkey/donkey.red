# Homepage improvement checklist

## Priority 1 — Sharpen the core message
...
- [x] Reconsider “vibe-coded slop.”
  ...
  - Possible replacement: “Not throwaway prototypes, but durable, well-engineered systems.”
- [x] Soften or concretize the inequality/social-impact paragraph.
  - Keep the values, but make the benefit more specific and less abstract.
- [x] Use “Red Donkey” after the first mention instead of repeating the full legal name.
...
- [x] Change “focus doing your best work” to “focus on doing your best work.”
- [x] Change “an vague ambitious idea” to “a vague, ambitious idea.”
- [x] Choose one spelling convention and apply it consistently:
  - Canadian/British: focussing, organisation
  - American: focusing, organization
- [x] Consider replacing “boutique software consultancy” if it feels too generic.
  - Possible alternatives: “small software studio,” “custom software practice,” “practical technology partner.”

## Later ideas

- [x] Move mission/manifesto material onto the About page so it does not overload the homepage. (Mission section on About page rewritten 2026-05-20: leads with the economics shift, bolded ledes per paragraph, lands on "Turn up the good.")
- [ ] Add a lightweight case study once there is a suitable example.
- [ ] Add testimonials or partner logos when available.
- [ ] Consider a separate services page if the homepage starts carrying too much detail.
- [ ] Consider a simple “first conversation” form with prompts:
